...
Segments are stored as content-addressable MP3 files under the segment_cache
data directory. The cache key is a SHA-256 hash of the inputs that determine
the audio output (text, voice_id, preset for voice; description, duration for
SFX/ambient; duration_ms for pauses).
"""
