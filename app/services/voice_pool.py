...
VOICE_POOL: list[VoiceEntry] = [
    # ── Male voices ──────────────────────────────────────────────
    VoiceEntry("7p1Ofvcwsv7UBPoFNcpI",
               "Julian",
               "male",
               "adult",
    ...
    VoiceEntry("Gsndh0O5AnuI2Hj3YUlA",
               "Adam",
               "male",
               "adult",
               ...
               "narrator",
               "eleven_multilingual_v2"),
    VoiceEntry("ErXwobaYiN019PkySvjV",
               "Antoni",
               "male",
               "adult",
               ...
               "character",
               "eleven_multilingual_v2"),
    VoiceEntry("VR6AewLTigWG4xSOukaG",
               "Arnold",
               "male",
               "adult",
               ...
               "character",
               "eleven_multilingual_v2"),
    VoiceEntry("TxGEqnHWrfWFTfGW9XjX",
               "Josh",
               "male",
               "young",
               ["young", "deep", "confident", "protagonist"]),
    VoiceEntry("yoZ06aMxZJJ28mfd3POQ",
               "Sam",
               "male",
               "adult",
               ["raspy", "rough", "sinister", "gravelly", "threatening"]),
    VoiceEntry("jvcMcno3QtjOzGtfpjoI",
               "David A",
               "male",
               "elder",
               ...
               "narrator",
               "eleven_multilingual_v2"),
    VoiceEntry("2EiwWnXFnvU5JabPnv8n",
               "Clyde",
               "male",
               "elder",
               ["old", "veteran", "weathered", "grizzled", "wise"]),
    VoiceEntry("SOYHLrjzK2X1ezoPC6cr",
               "Harry",
               "male",
               "young",
               ["young", "anxious", "nervous", "scared", "uncertain"]),
    VoiceEntry("uDsPstFWFBUXjIBimV7s",
               "Santa (yes, really)",
               "male",
               "elder",
               ...
               "narrator",
               "eleven_multilingual_v2"),
    VoiceEntry("GBv7mTt0atIp3Br8iCZE",
               "Thomas",
               "male",
               "adult",
               ["calm", "steady", "matter-of-fact", "professional"]),
    VoiceEntry("ZQe5CZNOzWyzPSCn5a3c",
               "James",
               "male",
               "elder",
               ["old", "calm", "gentle", "grandfather", "wise", "ominous"]),
    VoiceEntry("TX3LPaxmHKxFdv7VOQHJ",
               "Liam",
               "male",
               "young",
               ["young", "energetic", "narrator", "articulate"]),
    VoiceEntry("D38z5RcWu1voky8WS1ja",
               "Fin",
               "male",
               "adult",
               ["irish", "storyteller", "folksy", "eerie"]),
    VoiceEntry("CYw3kZ02Hs0563khs1Fj",
               "Dave",
               "male",
               "adult",
               ["conversational", "british", "everyman", "relatable"]),
    VoiceEntry("dHd5gvgSOzSfduK4CvEg",
                "Jerry",
                "male",
                "adult",
                ...
                "character",
                "eleven_multilingual_v2"),
    VoiceEntry("Bj9UqZbhQsanLzgalpEG",
                "Austin",
                "male",
                "adult",
    ...
    # ── Female voices ────────────────────────────────────────────
    VoiceEntry("uYXf8XasLslADfZ2MB4u",
               "Hope",
               "female",
               "young",
               ...
               "character",
               "eleven_multilingual_v2"),
    VoiceEntry("7YaUDeaStRuoYg3FKsmU",
               "Callie",
               "female",
               "young",
               ...
               "narrator",
                "eleven_multilingual_v2"),
    VoiceEntry("Ofxg0EhLSipL3WfvcXDG",
                "Major Elizabeth",
                "female",
                "elder",
                ...
                "character",
                "eleven_multilingual_v2"),
    VoiceEntry("21m00Tcm4TlvDq8ikWAM",
               "Rachel",
               "female",
               "adult",
               ["calm", "narrator", "warm", "composed", "steady"]),
    VoiceEntry("EXAVITQu4vr4xnSDxMaL",
               "Bella",
               "female",
               "young",
               ["soft", "gentle", "quiet", "whispery", "innocent"]),
    VoiceEntry("kkPJzQOWz2Oz9cUaEaQd",
               "Beatrice",
               "female",
               "elder",
               ["old", "wisdom", "narrator", "grandmother", "crone"]),
    VoiceEntry("a5zfmqTslZJBP0jutmVY",
                "Jen",
                "female",
                "adult",
                ...
                "character",
                "eleven_multilingual_v2"),
    VoiceEntry("AZnzlk1XvdvUeBnXmlld",
               "Domi",
               "female",
               "adult",
               ["strong", "confident", "assertive", "commanding"]),
    VoiceEntry("MF3mGyEYCl7XYWbV9V6O",
               "Elli",
               "female",
               "young",
               ["young", "cheerful", "bright", "girl", "innocent"]),
    VoiceEntry("jsCqWAovK2LkecY7zXl4",
               "Freya",
               "female",
               "young",
               ["young", "narrator", "expressive", "protagonist"]),
    VoiceEntry("XB0fDUnXU5powFXDhCwa",
               "Charlotte",
               "female",
               "adult",
               ["seductive", "smooth", "mysterious", "sinister", "alluring"]),
    VoiceEntry("oWAxZDx7w5VEj9dCyTzz",
               "Grace",
               "female",
               "adult",
               ["southern", "warm", "motherly", "folksy"]),
    VoiceEntry("ThT5KcBeYPX3keUQqHPh",
               "Dorothy",
               "female",
               "young",
               ["young", "pleasant", "sweet", "kind"]),
    VoiceEntry("86V9x9hrQds83qf7zaGn",
               "Marcela",
                "female",
                "young",
               ...
               "character",
               "eleven_multilingual_v2"),
    VoiceEntry("7NsaqHdLuKNFvEfjpUno",
               "Morgana",
               "female",
               "elder",
               ["old", "witch", "eerie", "sinister", "raspy", "crone"]),
    VoiceEntry("pMsXgVXv3BLzUgSXRplE",
               "Serena",
               "female",
               "middle",
               ["calm", "middle-aged", "professional", "composed"]),
    VoiceEntry("piTKgcLEGmPE4e6mEKli",
               "Nicole",
               "female",
               "adult",
               ["whisper", "quiet", "airy", "ethereal", "ghostly"]),
    VoiceEntry("jBpfuIE2acCO8z3wKNLl",
               "Gigi",
               "female",
               "young",
    ...
    # ── Other voices ────────────────────────────────────────────
    VoiceEntry("kPtEHAvRnjUJFv7SK9WI",
                "Glitch",
                "other",
                "unknown",
                ...
                "character",
                "eleven_multilingual_v2"),
    VoiceEntry("wXvR48IpOq9HACltTmt7",
                "Dante",
                "other",
                "adult",
                ...
                "narrator",
                "eleven_multilingual_v2"),
    VoiceEntry("xYWUvKNK6zWCgsdAK7Wi",
                "Argonian",
                "other",
                "adult",
