...
class TestTtsRequest:
    ...
    @patch("services.elevenlabs.requests.post")
    @patch("services.elevenlabs.settings")
...
class TestGenerateAudio:
    @patch("services.elevenlabs.cleanup_temp_files")
    @patch("services.elevenlabs.create_tmp_folder")
    @patch("services.elevenlabs.tts_request")
    @patch("services.elevenlabs.os.rename")
    @patch("services.elevenlabs.os.makedirs")
    ...
    @patch("services.elevenlabs.cleanup_temp_files")
    @patch("services.elevenlabs.stitch_audio_files")
    @patch("services.elevenlabs.create_tmp_folder")
    @patch("services.elevenlabs.tts_request")
    ...
    def test_generates_output_path_when_none(
        ...
        # Should auto-generate a path under the stories directory
...
class TestGenerateSfx:
    ...
    @patch("services.elevenlabs.requests.post")
    @patch("services.elevenlabs.settings")
    @patch("services.elevenlabs.os.path.exists", return_value=False)
    @patch("services.elevenlabs.os.makedirs")
    ...
    @patch("shutil.copy2")
    @patch("services.elevenlabs.os.path.exists", return_value=True)
    @patch("services.elevenlabs.os.makedirs")
    ...
    def test_auto_generates_output_path_from_hash(self, mock_settings, mock_post, tmp_path):
        ...
        with patch("services.elevenlabs.SFX_CACHE_DIR", cache_dir):
