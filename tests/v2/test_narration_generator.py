...
from services.segment_cache import CacheLookupResult
...
class TestGenerateSegment:
    ...
    @patch("services.narration_generator.generate_audio")
    ...
    @patch("services.narration_generator.generate_sfx")
    ...
    @patch("services.narration_generator.AudioSegment")
...
class TestGenerateNarration:
    ...
    @patch("services.narration_generator.os.makedirs")
    @patch("services.narration_generator.cache_lookup")
    @patch("services.narration_generator.mix_narration")
    @patch("services.narration_generator.generate_sfx")
    @patch("services.narration_generator.generate_audio")
